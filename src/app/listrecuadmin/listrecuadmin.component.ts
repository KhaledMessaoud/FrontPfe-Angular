...
@Component({
  selector: 'app-listrecuadmin',
  templateUrl: './listrecuadmin.component.html',
  styleUrls: ['./listrecuadmin.component.css']
})
export class ListrecuadminComponent implements OnInit {
